...
const SpecialOffer = () => {
  return (
    <section className="bg-solarrio-orange py-12 md:py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
          <h3 className="text-xl md:text-2xl font-bold text-center mb-6 text-solarrio-dark">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start">
              <CheckCircle className="w-6 h-6 text-solarrio-orange flex-shrink-0 mr-2 mt-0.5" />
          ...
          <div className="text-center">
            <a
              href={FORM_URL}
              className="inline-block bg-solarrio-orange text-white py-3 px-8 rounded-md text-lg font-medium hover:brightness-110 transition-all"
            >
