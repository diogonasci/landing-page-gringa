...
const HowItWorks = () => {
  return (
    <section id="como-funciona" className="bg-solarrio-dark py-12 md:py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-2xl md:text-3xl font-bold mb-10 text-white">
          Como <span className="text-solarrio-orange">funciona</span>?
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Step 1 */}
          <div className="flex flex-col items-center text-center">
            <div className="w-12 h-12 bg-solarrio-orange rounded-full flex items-center justify-center mb-4 relative">
              <span className="text-white font-bold text-xl">1</span>
              <div className="absolute -inset-1 rounded-full bg-solarrio-orange/30 animate-pulse"></div>
            </div>
