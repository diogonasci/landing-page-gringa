    ...
    <section id="por-que-escolher" className="bg-white py-12 md:py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-2xl md:text-3xl font-bold mb-3 text-solarrio-dark">
          Por que escolher a{" "}
          <span className="text-solarrio-orange">SolarRio</span>?
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center p-6 border border-gray-200 rounded-lg shadow-sm">
            <div className="w-16 h-16 bg-solarrio-orange/10 rounded-full flex items-center justify-center mb-4">
              <Shield className="w-8 h-8 text-solarrio-orange" />
            </div>
          ...
          <div className="flex flex-col items-center text-center p-6 border border-gray-200 rounded-lg shadow-sm">
            <div className="w-16 h-16 bg-solarrio-orange/10 rounded-full flex items-center justify-center mb-4">
              <Timer className="w-8 h-8 text-solarrio-orange" />
            </div>
          ...
          <div className="flex flex-col items-center text-center p-6 border border-gray-200 rounded-lg shadow-sm">
            <div className="w-16 h-16 bg-solarrio-orange/10 rounded-full flex items-center justify-center mb-4">
              <CheckCircle className="w-8 h-8 text-solarrio-orange" />
            </div>
        ...
        <div className="mt-16 bg-gray-50 p-8 rounded-lg border border-gray-200 max-w-3xl mx-auto text-center">
          ...
          <p className="font-bold text-solarrio-dark">
            Eng. Roberto Carvalho - Diretor Técnico da SolarRio
          </p>
        </div>
      </div>
    </section>
